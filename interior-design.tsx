    ...
    <header className={headerClasses}>
      <div className="logo">
        <AppLink href="/index.html">
          <img src="https://res.cloudinary.com/dj3vhocuf/image/upload/v1762341232/DESign_220_x_60_px_abhv5e.png" alt="Taj Design Consultancy Logo - Architectural Firm in Qatar" className="logo-image" />
        </AppLink>
      </div>
    ...
    <section className="cta-section scroll-trigger fade-up">
        <div className="container">
            ...
            <p className="scroll-trigger fade-up" style={{ transitionDelay: '0.2s' }}>
                Ready to transform your interior? Our team is here to bring your vision to life with creativity and precision. Contact us to start the conversation.
            </p>
...
const ServicePage = () => {
  ...
  const services = [
    ...
    'Authority Approvals (Baladiya & QCDD)',
  ...
  const relatedProjects = [
    { image: "https://res.cloudinary.com/dj3vhocuf/image/upload/f_auto,q_auto,w_800/v1761224706/WhatsApp_Image_2025-10-22_at_23.46.06_e814e5d0_uqphxj.png", title: "TrustLink Office", category: "Commercial Interior" },
    { image: "https://res.cloudinary.com/dj3vhocuf/image/upload/f_auto,q_auto,w_800/v1761733626/Untitled_design_-_2025-10-29T155509.760_nzctlr.png", title: "World Wide Business Center", category: "Office Fit-Out" },
    { image: "https://res.cloudinary.com/dj3vhocuf/image/upload/f_auto,q_auto,w_800/v1761394147/10_gtnarf.png", title: "Legal Office, Westbay", category: "Corporate Interior" },
  ];
            ...
            <div className="container">
              <div className="service-content-grid scroll-trigger fade-up" style={{transitionDelay: '0.2s'}}>
                <div className="service-main-content">
                  <p>
                    At Taj Design Consultancy, we create interior spaces that are not just beautiful but also functional, inspiring, and aligned with our clients' brand identity. Our end-to-end interior design and fit-out service covers every stage of the project lifecycle, from initial concept and space planning to the final handover. We specialize in transforming commercial, corporate, and retail environments into engaging and productive spaces that leave a lasting impression.
                  </p>
                  <p>
                    Our process is collaborative and detail-oriented. We work closely with clients to understand their vision, operational needs, and budget. This allows us to develop tailored design solutions that are both innovative and practical. Our expertise includes securing all necessary authority approvals from Baladiya and QCDD, ensuring a smooth and compliant process. We manage everything from detailed drawings and material selection to tendering, site supervision, and snag-free completion, delivering turnkey solutions that bring your vision to life.
                  </p>
                </div>
                <div className="service-sidebar-image">
                  <img src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&auto=format&fit=crop&q=60" alt="A beautifully designed modern living room interior showcasing our expertise." />
                </div>
              </div>

              <div className="service-list-section scroll-trigger fade-up" style={{transitionDelay: '0.3s'}}>
                <h2 className="section-title">Our Interior Design & Fit-Out services include:</h2>
