...
const blogPosts = [
    ...
    { 
      ...
      content: [
        ...
        { type: 'image', src: 'https://plus.unsplash.com/premium_photo-1714023800301-83390690e1f0?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Z3JlZW4lMjBidWlsZGluZ3xlbnwwfHwwfHx8MA%3D%3D&fm=jpg&q=60&w=3000?w=800&auto=format&fit=crop&q=60', captionTitle: 'Eco-Conscious Living Spaces', captionText: 'Integrating greenery and natural light is key to sustainable design in modern construction.' },
